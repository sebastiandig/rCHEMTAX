...
|            | or:green"} |                      |                   |
+------------+------------+----------------------+-------------------+
| *bootln*   | [**        | *nnmatfactsd*        | close to          |
|            | Works**]{s |                      | finishing         |
|            | tyle="colo |                      |                   |
|            | r:yellow"} |                      |                   |
+------------+------------+----------------------+-------------------+
| *bootnp*   | [**        | *nnmatfactsd*        | close to          |
|            | Works**]{s |                      | finishing         |
|            | tyle="colo |                      |                   |
|            | r:yellow"} |                      |                   |
+------------+------------+----------------------+-------------------+
...
+------------+------------+----------------------+-------------------+
| *CHEMTAXB  | [          |                      | as *.csv* in      |
| ROKEWests* | **Done**]{ |                      | *data/raw/*       |
|            | style="col |                      |                   |
|            | or:green"} |                      |                   |
+------------+------------+----------------------+-------------------+
| *CHEMTAXB  | [          |                      | as *.csv* in      |
| ROKEWestx* | **Done**]{ |                      | *data/raw/*       |
|            | style="col |                      |                   |
|            | or:green"} |                      |                   |
+------------+------------+----------------------+-------------------+
...
|            | **Done**]{ |                      | to anything and   |
|            | style="col |                      | is not a          |
|            | or:green"} |                      | function, not     |
|            |            |                      | sure what do do   |
|            |            |                      | with it           |
+------------+------------+----------------------+-------------------+
| *i         | [          |                      | creates options   |
...
+------------+------------+----------------------+-------------------+
| *normprod* | [          |                      | normalizes to     |
|            | **Done**]{ |                      | selected column   |
|            | style="col |                      |                   |
|            | or:green"} |                      |                   |
+------------+------------+----------------------+-------------------+
| *permcalc* | [          |                      |                   |
