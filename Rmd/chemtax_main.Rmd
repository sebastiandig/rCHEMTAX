...
* "CHEMTAXBROKEWestb"             ---- mostly done * connected to `matfactuvw`, 
                                       `permcalc`, file for `b` as 
                                       `b_pigment_ratios.csv`, file for `x` as 
                                       `CHEMTAXBROKEWestx.csv``

* "CHEMTAXBROKEWests"             ---- * finished, as .csv in `data/raw/`  

* "CHEMTAXBROKEWestx"             ---- * finished, as .csv in `data/raw/`

* "dataout"                       ---- probably don't need     
...
* "matfactuvw"                    ---- * connected to  `initstruct`
