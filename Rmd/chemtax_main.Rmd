...
+-----------+-----------+---------------+-----------+-----------+
| Function  | S tatus   | Connections   | Notes     | R         |
|           |           |               |           | e         |
|           |           |               |           | designed? |
+===========+===========+===============+===========+===========+
| *adddir*  | [ **NA**] |               | I don't   |           |
...
|           | yel low"} |               |           |           |
+-----------+-----------+---------------+-----------+-----------+
| -   br    | [Done     | -   *chem     | **is main |           |
| okewest\* | \*\*]{s   | taxbrokewest* | starting  |           |
|           | tyle=     | -             | point for |           |
|           | "colo r:  | *nnmatfactsd* | data and  |           |
|           | gr een"}  | -             | a         |           |
|           |           |    *normprod* | nalysis** |           |
|           |           | -   *regplot* |           |           |
|           |           | -             |           |           |
...
+-----------+-----------+---------------+-----------+-----------+
| *chemtax  | [Done     | -             | calls     |           |
| b         | \*\*]{s   |    *permcalc* | data and  |           |
| rokewest* | tyle=     | -   file for  | pigment   |           |
|           | "colo r:  |     *s* and   | ratio     |           |
|           | gr een"}  |     *scol* as | matrix,   |           |
|           |           |               | selects   |           |
|           |           |   -   CHEMTAX | pigments  |           |
|           |           | BROKEWests\*, | for both  |           |
|           |           | -   file for  | and       |           |
...
+-----------+-----------+---------------+-----------+-----------+
| *CHEMTAXB | [ **Needs | -             | TODO:     |           |
| R         | wo rk**]  |  *matfactuvw* | test      |           |
| OKEWestb* | {styl     | -             | m         |           |
|           | e="co     |    *permcalc* | atfactuvw |           |
|           | lor:      | -   file for  | with this |           |
|           | red"}     |     *b* as    |           |           |
|           |           |     *b\_      |           |           |
|           |           |     pigmen    |           |           |
|           |           | t_ratios.csv* |           |           |
...
+-----------+-----------+---------------+-----------+-----------+
| *nn       | [Done     | -             | [**MAIN   |           |
| m         | \*\*]{s   |  *amatfactsd* | script    |           |
| atfactsd* | tyle=     | -             | for       |           |
|           | "colo r:  |  *initstruct* | factor    |           |
|           | gr een"}  |               | ana       |           |
|           |           |               | l         |           |
|           |           |               | ysis**]{s |           |
|           |           |               | t         |           |
