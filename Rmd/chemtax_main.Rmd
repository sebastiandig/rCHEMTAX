...
* "bootln"                        ---- mostly done * connected to `nnmatfactsd`
* "bootnp"                        ---- mostly done * connected to `nnmatfactsd`             
* "brokewest"                     ---- mostly done * connected to `chemtaxbrokewest`, 
                                  `nnmatfactsd`,  `normprod`, `regplot`, 
                                  `randstart`, `bootln`, `bootnp`
* "chemtaxbrokewest"              ---- mostly done * connected to `permcalc`, 
                                  `CHEMTAXBROKEWests`
* "CHEMTAXBROKEWestb"             ---- mostly done * connected to `matfactuvw`, `permcalc`
* "CHEMTAXBROKEWests"             ---- could be a .csv file     
* "CHEMTAXBROKEWestx"             ---- could be a .csv file  
* "dataout"                       ---- I don't know if it's needed? since sink function does what is needed?            
* "Formulas"           
* "initstruct"          
* "matfactuvw"          
* "nnmatfactsd"         
